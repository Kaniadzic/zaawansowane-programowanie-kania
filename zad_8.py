...
class HttpClient():
    ...
    def get(self, items_per_page: int, city: str = ""):
        return requests.get(self.url, params={'by_city': city, 'per_page': items_per_page}).content
...
breweries = http_client.deserialize_data(http_client.get(20, args.city))
